...
<body>
    <div class="container">
        <div class="header">
            <h1>🎓 Путеводитель по техническим вузам и специальностям</h1>
    ...
    <script>
        ...
        const specialtyDescriptions = {
            ...
            "ИНФОРМАЦИОННАЯ БЕЗОПАСНОСТЬ": "Защита информации в компьютерных системах, криптография,网络安全. Востребованная специальность в условиях цифровизации экономики.",
        ...
        const universitiesData = {
            ...
            "ЕКАТЕРИНБУРГ": {
                "УРФУ": [
                    ...
                    { name: "ХИМИЧЕСКАЯ ТЕХНОЛОГИЯ", score: "н/д", subjects: "р х м/и/ф" },
                ...
                "УРГУПС": [
                    { name: "ИНФОРМАЦИОННЫЕ СИСТЕМЫ И ТЕХНОЛОГИИ", score: 201, subjects: "р м и/ф" },
                    { name: "ИНФОРМАЦИОННЫЕ СИСТЕМЫ И ТЕХНОЛОГИИ", score: 195, subjects: "р м и/ф" },
